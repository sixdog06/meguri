...
# 无关"的语料也挡在门外（citation 不给错配背书）。
# 真 embedding（bge-m3，2026-08-27 实测）：相关 0.75-0.83、同作品邻站 ≈0.66、
# 跨作品 ≈0.51-0.53、完全无关 ≈0.40——0.6 仍有干净分离，沿用；换其他模型
# 需按同样方法重新标定。运行时可用 MEGURI_CORPUS_MIN_SCORE 覆盖。
